  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'light-card': '0 1px 3px 0 rgba(0, 0, 0, 0.06), 0 1px 2px -1px rgba(0, 0, 0, 0.06)',
        'light-card-hover': '0 4px 6px -1px rgba(0, 0, 0, 0.08), 0 2px 4px -2px rgba(0, 0, 0, 0.05)',
        'light-sidebar': '0 0 20px 0 rgba(0, 0, 0, 0.05)',
      },
    },
  },
  plugins: [],
